...
class FeedbackScreenWeb extends StatefulWidget {
  ...
  @override
  State<FeedbackScreenWeb> createState() => _ReportScreenState();
}

class _ReportScreenState extends State<FeedbackScreenWeb> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                      ...
                      child: Image.asset("assets/titles/feedback.png", scale: 4.5,)
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 30, right: 10, bottom: 15),
                  child: const Text(
