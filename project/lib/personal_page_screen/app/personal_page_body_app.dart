...
class Menu extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    List<MenuCard> options = [
      MenuCard(
          text: 'Gestão de Backoffice',
          description: '',
      ...
      MenuCard(text: 'O meu perfil',
          description: 'Vê o teu perfil e edita as tuas informações',
          icon: Icons.person_outline,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => ProfileApp()));
          }),
      MenuCard(text: 'Comprovativo',
          description: 'Acede ao comprovativo da tua vinculação com a FCT NOVA',
          icon: Icons.card_membership_outlined,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => ProofScreen()));
          }),
      MenuCard(text: 'Calendário',
          description: 'Tem à mão a tua agenda para te organizares facilmente',
          icon: Icons.calendar_month_outlined,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => CalendarPageApp()));
          }),
      MenuCard(text: 'Fóruns',
          description: 'Acede a fóruns informativos e mantém-te informado',
          icon: Icons.message_outlined,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => ForumScreenApp()));
          }),
      MenuCard(text: 'Reportar',
          description: 'Reporta um problema que encontraste no campus',
          icon: Icons.report_outlined,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => ReportPageApp()));
          }),
      MenuCard(text: 'Organizar Evento',
          description: 'Organiza um evento na faculdade de forma fácil e rápida',
          icon: Icons.event_available_outlined,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => AppPublishPage()));
          }),
      MenuCard(text: 'Feedback',
          description: 'A tua opiião é importante para nós. Submete-a aqui',
          icon: Icons.bar_chart_outlined,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => FeedbackPageApp()));
          }),
      MenuCard(text: 'Mudar Palavra-passe',
          description: '',
          icon: Icons.password_outlined,
          press: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => ModifyPwdPageApp()));
          }),
      MenuCard(
          text: 'Apagar Conta', description: '', icon: Icons.delete, press: () {
        showDialog(
            context: context,
            builder: (_) =>
                ConfirmDialogBox(
                    descriptions: "Tens a certeza que pretendes eliminar a tua conta?",
                    press: () {
          ...
          Container(
            ...
            child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  if(option.text=='Gestão de Backoffice' && (Authentication.role!='BO' && Authentication.role!='A'))
                    return SizedBox();
                  else if(option.text=='Organizar Evento' && (Authentication.role!='W' && Authentication.role!='T' && Authentication.role!='A'))
                    return SizedBox();
                  else return option;
                }),
          )
